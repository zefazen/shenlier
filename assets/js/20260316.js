...
const txtDoa = "<b style='font-size:16px'>Selamat hari raya idul fitri!!! ✨</b><br><br>Mohon maaf lahir dan batin dari aku untuk kamu, aku mau minta maaf sama semua kesalahan aku mungkin dari omongan, atau tingkah laku aku ke kamu 🫠";
const txtPesanAkhir = "Aku gatau seberapa besar salah aku ke kamu tapi aku minta maaf ke kamu yaa, jadi dimaafin ngga nih? harusnya dimaafin lah yaaa, kalo ga dimaafin yaudah deh aku minta pap di hari ini aja mwhehe 🤭😋💗";
const txtLucu = "── ᯓᡣ𐭩<br><b>Selamat lebaran sayaangg 🫶❤️</b>";
    ...
    function bukaEnvelope() {
      ...
      setTimeout(() => {
        ...
        setTimeout(() => {
          ...
          parts.forEach((part) => {
            if (part.toLowerCase() === '<br>' || part.toLowerCase() === '<br/>') {
              ...
              part.split('').forEach((char) => {
                ...
                // Kecepatan diatur di sini (0.12s = lebih lambat)
                span.style.animationDelay = `${charIndex * 0.12}s`; 
          ...
          const totalDuration = (charIndex * 120) + 2200;
...
function balasWa() {
  ...
  const text = "Iyaaa, minal aidin wal faizin juga ya! ✨ Udah dimaafin kok, tenang ajaa..Selamat lebaran juga sayang! 🫶❤️";
